...
public:
    ...
    void setupUi(QWidget *Client)
    {
        ...
        layoutWidget = new QWidget(groupBox_ConnexionServeur);
        layoutWidget->setObjectName(QString::fromUtf8("layoutWidget"));
        layoutWidget->setGeometry(QRect(10, 40, 296, 60));
        ...
        lineEdit_AdresseIpServeur = new QLineEdit(layoutWidget);
        ...
        label_NumeroPortServeur = new QLabel(layoutWidget);
        ...
        lineEdit_NumeroPortServeur = new QLineEdit(layoutWidget);
        ...
        groupBox_InformationsClient->setEnabled(false);
        groupBox_InformationsClient->setGeometry(QRect(10, 160, 541, 171));
        layoutWidget1 = new QWidget(groupBox_InformationsClient);
        layoutWidget1->setObjectName(QString::fromUtf8("layoutWidget1"));
        layoutWidget1->setGeometry(QRect(0, 30, 531, 131));
        ...
        pushButton_NomdOrdiDistant = new QPushButton(layoutWidget1);
        ...
        pushButton_NomUtilisateur = new QPushButton(layoutWidget1);
        ...
        pushButton_ArchitectureOrdi = new QPushButton(layoutWidget1);
        ...
        pushButton_OsOrdi = new QPushButton(layoutWidget1);
        ...
        lineEdit_NomOrdiDistant = new QLineEdit(layoutWidget1);
        ...
        lineEdit_NonUtilisateur = new QLineEdit(layoutWidget1);
        ...
        lineEdit_ArchitectureORdi = new QLineEdit(layoutWidget1);
        ...
        lineEdit_OsOrdi = new QLineEdit(layoutWidget1);
    ...
    void retranslateUi(QWidget *Client)
    {
        ...
        lineEdit_AdresseIpServeur->setText(QApplication::translate("Client", "172.18.58.147", nullptr));
