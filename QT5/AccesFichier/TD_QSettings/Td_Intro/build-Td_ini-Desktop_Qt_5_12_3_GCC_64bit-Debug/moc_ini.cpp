...
QT_INIT_METAOBJECT const QMetaObject ini::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_ini.data,
    qt_meta_data_ini,
    qt_static_metacall,
    nullptr,
    nullptr
